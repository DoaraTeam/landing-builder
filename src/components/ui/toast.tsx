...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "absolute right-2 top-2 rounded-md p-1 text-foreground/50 opacity-0 transition-opacity hover:text-foreground focus:opacity-100 focus:outline-none focus:ring-2 group-hover:opacity-100 group-[.destructive]:text-red-300 group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:focus:ring-offset-red-600 group-[.success]:text-green-100 group-[.success]:hover:text-white group-[.success]:focus:ring-green-300 group-[.success]:focus:ring-offset-green-600 group-[.warning]:text-black/50 group-[.warning]:hover:text-black group-[.warning]:focus:ring-black/40 group-[.warning]:focus:ring-offset-amber-500",
      className
    )}
    toast-close=""
    {...props}
